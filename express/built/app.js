...
var LibgenDbService = require('./services/libgen-db.service').LibgenDbService;
var ENC = require('./services/secman').ENC;
var BookSyncService = require('./services/book-sync.service').BookSyncService;
var app = express();
