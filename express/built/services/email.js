...
const sendFileToKindle = (recipient, filePath, filename) => __awaiter(this, void 0, void 0, function* () {
    var mailOptions = {
        from: EMAIL_USERNAME,
        to: recipient,
        subject: 'new book',
    ...
    var result = yield mail.sendMail(mailOptions);
...
const sendPasswordResetMail = (recipient, hash) => __awaiter(this, void 0, void 0, function* () {
    var mailOptions = {
        from: SUPPORT_SENDER,
        to: recipient,
        subject: 'Password reset requested',
