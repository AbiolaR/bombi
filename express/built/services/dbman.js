...
module.exports.findUserAsync = (username) => __awaiter(this, void 0, void 0, function* () {
    return yield User.findOne({ username: username }).collation({ locale: 'de', strength: 2 });
});
...
module.exports.findUserByHashAsync = (hash) => __awaiter(this, void 0, void 0, function* () {
    return yield User.findOne({ passwordResetHash: hash });
});
...
module.exports.findUserByUsernameAndCode = (username, code) => __awaiter(this, void 0, void 0, function* () {
    return yield User.findOne({ username: username, passwordResetCode: code });
});
...
module.exports.updateUserAsync = (userdata) => __awaiter(this, void 0, void 0, function* () {
    return yield User.findOneAndUpdate({ username: userdata.username }, userdata);
});
